...
#include "SpotsEditorInteractiveTool.generated.h"


/**
 * Builder for USpotsEditorInteractiveTool
 */
UCLASS()
class SPOTSEDITOR_API USpotsEditorInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the USpotsEditorInteractiveTool
 */
UCLASS(Transient)
class SPOTSEDITOR_API USpotsEditorInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	USpotsEditorInteractiveToolProperties();
...
/**
 * USpotsEditorInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class SPOTSEDITOR_API USpotsEditorInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<USpotsEditorInteractiveToolProperties> Properties;
