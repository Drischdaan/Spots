...
#include "SpotsEditorInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "USpotsEditorInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* USpotsEditorInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	USpotsEditorInteractiveTool* NewTool = NewObject<USpotsEditorInteractiveTool>(SceneState.ToolManager);
...
USpotsEditorInteractiveToolProperties::USpotsEditorInteractiveToolProperties()
{
...
void USpotsEditorInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void USpotsEditorInteractiveTool::Setup()
{
	...
	Properties = NewObject<USpotsEditorInteractiveToolProperties>(this, "Measurement");
...
void USpotsEditorInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit USpotsEditorInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void USpotsEditorInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void USpotsEditorInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit USpotsEditorInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void USpotsEditorInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void USpotsEditorInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void USpotsEditorInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void USpotsEditorInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
